...
import com.clbee.readingocean.payload.PollRequest;
import com.clbee.readingocean.payload.PollResponse;
import com.clbee.readingocean.payload.VoteRequest;
import com.clbee.readingocean.repository.PollRepository;
...
public class PollService {
    ...
    public PagedResponse<PollResponse> getAllPolls(CustomUserDetails currentUser, int page, int size) {
    ...
    public PollResponse getPollById(Long pollId, CustomUserDetails currentUser) {
